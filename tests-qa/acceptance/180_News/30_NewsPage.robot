...
Leave Comment Panel - Anonymous
    Go To Url                                       ${PAGE_NEWS_URL}                newsid=1
    Element Should Contain                          ${NEWS_COMMENT_PANEL_CONTENT}   Please login to post a comment

Leave Comment Panel - Authenticated
    Sign In ${USER_1.name} Fast
    Go To Url                                       ${PAGE_NEWS_URL}                newsid=1
    Element Should Not Contain                      ${NEWS_COMMENT_PANEL_CONTENT}   Please login to post a comment
